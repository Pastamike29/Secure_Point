...
export default function HighRisk() {
  ...
  useEffect(() => {
    const fetchApplicationsByRisk = async () => {
      try {
        ...
        const highRiskData = data.data
          .filter((item: RiskRatingGroup) => item._id.toLowerCase() === 'high')
          .map((item) => ({
            ...item,
        ...
        setFilteredApplications(highRiskData); // Initialize filtered data
      } catch (error) {
  ...
  return (
    <DashboardLayout title="High Risk Applications">
            ...
            <Card elevation={4} sx={{ p: 2, borderRadius: '12px', backgroundColor: '#424242' }}>
              <CardContent>
                ...
                <Typography variant="h4" sx={{ fontWeight: 'bold', color: '#90caf9' }}>
                  {riskRatings.length > 0 && riskRatings[0]?.["Total Applications Scanned"] !== undefined
                    ? riskRatings[0]["Total Applications Scanned"]
                    : 'N/A'}
                </Typography>
              </CardContent>
            </Card>
            ...
            <Card elevation={4} sx={{ p: 2, borderRadius: '12px', backgroundColor: '#424242' }}>
              <CardContent>
                ...
                <Typography variant="h4" sx={{ fontWeight: 'bold', color: '#e57373' }}>
                  {riskRatings.length > 0 && riskRatings[0]?.["Total Findings"] !== undefined
                    ? riskRatings[0]["Total Findings"]
                    : 'N/A'}
                </Typography>
              </CardContent>
            </Card>
